...
- `sea_site_reward_helper.gd`: applies site reward profiles such as minor stat bonuses, upgrade choices, hull repair, crew training, crew limit expansion, and crew recovery.
