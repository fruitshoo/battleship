...
const PlayerShipCrewHelper = preload("res://scripts/entities/player_ship_crew_helper.gd")
const PlayerShipMovementHelper = preload("res://scripts/entities/player_ship_movement_helper.gd")
const PlayerShipSinkHelper = preload("res://scripts/entities/player_ship_sink_helper.gd")
const PlayerShipRuntimeHelper = preload("res://scripts/entities/player_ship_runtime_helper.gd")
const PlayerShipAuxHelper = preload("res://scripts/entities/player_ship_aux_helper.gd")
const PlayerShipSupportHelper = preload("res://scripts/entities/player_ship_support_helper.gd")
...
func set_rowing(active: bool) -> void:
	if active and not rowing_locked and rowing_stamina > 0:
		is_rowing = true
	else:
		is_rowing = false
...
func toggle_rowing() -> void:
	if not rowing_locked and rowing_stamina > 0:
