...
var _last_boost_ratio: float = -1.0
var _last_boost_ready: bool = false
var _last_boost_active: bool = false
var _boost_visual_value: float = 100.0
...
const PLAYER_STATUS_BOOST_HEIGHT: float = 5.0
const PLAYER_STATUS_BAR_GAP: float = 1.0
const PLAYER_STATUS_STACK_HEIGHT: float = 25.0
