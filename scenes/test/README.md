...
- `project_contract_sweep.tscn`
  Project-wide load sweep plus a legacy-pattern scan, a save/load roundtrip smoke, and a small runtime smoke check for registry, boss, ship, launcher, and projectile contracts.
