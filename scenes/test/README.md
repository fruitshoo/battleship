...
- `project_contract_sweep.tscn`
  Project-wide load sweep plus a legacy-pattern scan, save/load, HUD, support-fleet, and scene-wiring roundtrip smokes, and a small runtime smoke check for registry, boss, ship, launcher, and projectile contracts.
